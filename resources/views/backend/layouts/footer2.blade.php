<footer id="footer" class="footer">
    <div class="copyright">
        &copy; Copyright <strong><span>CUI Sahiwal</span></strong>. All Rights Reserved
    </div>
    <div class="credits">Designed by <strong><a href="mailto:musmanrajputt490@gmail.com">Muhammad Usman</a></strong><br>
        Under the Supervision of <strong><a href="https://github.com/Jamil226">Prof. Muhammad Jamil</a>
    </div>
</footer>
