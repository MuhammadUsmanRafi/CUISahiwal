...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <!-- Blogs -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#blogs-submenu" data-bs-toggle="collapse"
                    href="#">
            ...
            <!-- Speakers -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#speakers-submenu" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-mic"></i>
                    <span>Speakers</span>
                    <i class="bi bi-chevron-down ms-auto"></i>
            ...
            <!-- Events -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#events-submenu" data-bs-toggle="collapse"
                    href="#">
            ...
            <!-- Features -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#features-submenu" data-bs-toggle="collapse"
                    href="#">
            ...
            <!-- Sessions -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#sessions-submenu" data-bs-toggle="collapse"
                    href="#">
            ...
            <!-- FAQs -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#faqs-submenu" data-bs-toggle="collapse"
                    href="#">
