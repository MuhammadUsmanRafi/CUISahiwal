...
<html lang="en">
  <!-- Mirrored from expert-themes.com/html/eventrox/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 May 2024 06:19:49 GMT -->
  <head>
    <meta charset="utf-8" />

    <title>Eventrox - Digital Events HTML Template | Pricing</title>
          ...
          <div class="outer-box">
            <div class="row">
              ...
              >
                <div class="inner-box">
                  <div class="title">
                    <span class="icon flaticon-movie-tickets"></span> Day Pass
                  </div>
                  ...
                  <div class="btn-box">
                    <a href="buy-ticket.html" class="theme-btn btn-style-one"
                      ><span class="btn-title">BUY Ticket</span></a
                    >
                  </div>
                </div>
              </div>
              ...
              >
                <div class="inner-box">
                  <div class="title">
                    <span class="icon flaticon-movie-tickets"></span> Full Pass
                  </div>
              ...
              >
                <div class="inner-box">
                  <div class="title">
                    <span class="icon flaticon-movie-tickets"></span> Group Pass
                  </div>
        ...
        <div class="auto-container">
          ...
          <div class="outer-box">
            <div class="row">
              ...
              <div
                class="pricing-block-three col-lg-4 col-md-6 col-sm-12 wow fadeInUp"
              >
                <div class="inner-box">
